...
public class CodeGenerator {
     ...
     * 数据库链接地址
     */
    private static final String URL = "jdbc:mysql://localhost:3306/base?useUnicode=true&useSSL=false&characterEncoding=utf8";
     ...
     * 作者
     */
    private static final String AUTHOR = "Geekerstar";

    /**
     * 父包名
     */
    private static final String PACKAGE_PARENT = "com.geekerstar.auto";
    ...
    private static InjectionConfig getInjectionConfig() {
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return System.getProperty("user.dir") + "/src/main/resources/mapper/auto/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
    ...
    public static void main(String[] args) {
        // 执行
        getAutoGenerator("sys_user").execute();
    }
}
