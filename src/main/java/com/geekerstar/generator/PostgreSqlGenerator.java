...
public class PostgreSqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:postgresql://?useUnicode=true&serverTimezone=GMT&useSSL=false&characterEncoding=utf8");
...
//                        + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
                return projectPath + "/src/main/resources/mapper/auto/"
                        + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
